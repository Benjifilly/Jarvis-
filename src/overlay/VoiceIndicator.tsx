          ...
          <div className="flex items-center gap-3 rounded-full border border-white/10 bg-ink-900/75 px-5 py-2.5 shadow-glow-soft backdrop-blur-xl">
            {status === "recording" ? (
              <>
                ...
                <span className="text-sm text-white/85">À l'écoute…</span>
              </>
            ) : status === "transcribing" ? (
              <>
              ...
              <>
                <span className="inline-block h-2.5 w-2.5 animate-pulse rounded-full bg-glow-cyan" />
                <span className="text-sm text-white/75">
                  En écoute — parlez quand vous voulez
                </span>
              </>
            )}
          </div>
